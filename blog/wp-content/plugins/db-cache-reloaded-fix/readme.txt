...
This plugin is based on [DB Cache Reloaded](http://wordpress.org/extend/plugins/db-cache-reloaded/) by sirzooro. I patch it so it have WordPress 3.4 compatibility.
